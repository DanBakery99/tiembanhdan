import{i as c}from"./data-BiYLU9UV.js";const x=()=>{const e=localStorage.getItem("siteData");if(!e)return c;try{const t=JSON.parse(e);return t.hero||(t.hero=JSON.parse(JSON.stringify(c.hero))),t.menu||(t.menu=JSON.parse(JSON.stringify(c.menu))),t.contact||(t.contact=JSON.parse(JSON.stringify(c.contact))),t.gallery||(t.gallery=JSON.parse(JSON.stringify(c.gallery))),t.menu.items&&t.menu.items.forEach(o=>{o.category==="món mặn"&&(o.category="bánh ngọt")}),((o,a)=>{for(const s in a)(o[s]===void 0||o[s]===null||o[s]==="")&&(o[s]=a[s])})(t.contact,c.contact),(!t.hero.backgroundImages||t.hero.backgroundImages.length===0)&&(t.hero.backgroundImages=c.hero.backgroundImages),t}catch(t){return console.error("Lỗi khi tải dữ liệu từ localStorage:",t),c}},n=x(),f=()=>{const e=n.contact.zaloUrl,t=n.contact.phone;return e&&e!=="#"?e:t?`tel:${t.replace(/\s/g,"")}`:"#"},h=()=>{const e=n.contact.zaloUrl;return e&&e!=="#"?"💬 Nhắn Zalo Đặt Món":"📞 Gọi Đặt Món"},y=()=>{const e=n.contact.phone;return e?`tel:${e.replace(/\s/g,"")}`:"#"},b=()=>{const e=document.getElementById("hero-stats");if(!e)return;const t=n.contact.googleRating,r=n.contact.googleReviewCount;e.innerHTML=`
    ...
    `},v=()=>{const e=document.getElementById("hero-img-1"),t=document.getElementById("hero-img-2"),r=document.getElementById("hero-img-mobile");if(n.hero&&n.hero.backgroundImages){const o=n.hero.backgroundImages;e&&o[0]&&(e.src=o[0].src),t&&o[1]&&(t.src=o[1].src),r&&o[0]&&(r.src=o[0].src)}},w=()=>{const e=document.getElementById("hero-cta-container");if(!e)return;const t=f(),r=h(),o=y();e.innerHTML=`
        <a href="#menu"
    ...
    `},k=[{id:null,name:"Tất Cả"},{id:"bánh sinh nhật",name:"🎂 Bánh Sinh Nhật"},{id:"đồ uống",name:"☕ Đồ Uống"},{id:"bánh ngọt",name:"🍰 Bánh Ngọt"}],$=()=>{const e=document.getElementById("category-filters");e&&(e.innerHTML=k.map(t=>`
    ...
    `).join("")},I=()=>{const e=document.getElementById("menu-section-cta");if(!e)return;const t=f(),r=h();e.href=t,e.setAttribute("target","_blank"),e.setAttribute("rel","noopener"),e.textContent=r},E=()=>{const e=document.getElementById("google-rating-summary"),t=document.getElementById("reviews-container"),r=document.getElementById("google-map-iframe"),o=document.getElementById("google-maps-link"),a=document.getElementById("get-directions-btn"),s=document.getElementById("display-address"),l=n.contact.googleRating,d=n.contact.googleMapsUrl||"#";if(e)if(l){const i=Math.floor(l),g=l-i>=.5;let p="";for(let m=0;m<i;m++)p+='<span class="text-yellow-400">★</span>';g&&(p+='<span class="text-yellow-300">★</span>');for(let m=i+(g?1:0);m<5;m++)p+='<span class="text-gray-300">★</span>';e.innerHTML=`
